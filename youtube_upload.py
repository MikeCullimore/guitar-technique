"""
Upload video to YouTube. Work in progress!

Adapted from https://developers.google.com/youtube/v3/guides/uploading_a_video
...
# TODO: fix these imports? Instead use google-auth-oauthlib, oauthlib?
# from oauth2client.client import flow_from_clientsecrets
# from oauth2client.file import Storage
# from oauth2client.tools import argparse, run_flow
...
#     credentials = run_flow(flow, storage, args)
  ...
  credentials = google_auth_oauthlib.get_user_credentials(
    YOUTUBE_UPLOAD_SCOPE, client_id, client_secret)
